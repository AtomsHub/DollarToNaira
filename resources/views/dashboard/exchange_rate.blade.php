                ...
                <div class="sidebar mt-md-5 mt-0 offcanvas-md offcanvas-end" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
                    ...
                    <div class="top-sidebar">
                        <ul class="list-unstyled mb-0">
                            <li>
                                <a href="{{ route('dashboardindex.index') }}" class="d-flex align-items-center gap-4 ">
                            ...
                            <li>
                                <a href="{{ Route('currencies.index') }}" class="d-flex align-items-center gap-4">
                            ...
                            <li>
                                <a href="{{ Route('exchange-rates.index') }}" class="d-flex align-items-center gap-4 active">
