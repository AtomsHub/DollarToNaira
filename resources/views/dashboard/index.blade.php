                ...
                <div class="sidebar offcanvas-md offcanvas-end" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
                    ...
                    <div class="top-sidebar">
                        <ul class="list-unstyled mb-0">
                            <li>
                                <a href="{{ route('dashboardindex.index') }}" class="d-flex align-items-center gap-4 active">
                                    ...
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_171_594" x1="-3.20233" y1="11.5936" x2="6.89439" y2="-3.32555" gradientUnits="userSpaceOnUse">
                    ...
                    <div class="dashboard-content_balance d-flex flex-wrap flex-md-nowrap gap-3 mb-4" style="box-sizing: border-box;">
                        ...
                        <div class="col-lg-4 col-md-auto col balance-card ">
                            ...
                            <div class="d-flex align-items-center gap-3 mt-4">
                                ...
                                <p class="balance-card_title">24</p>
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-auto col balance-card">
                            <p class="balance-card_subtitle">Total Exchange Rate</p>
                            <div class="d-flex align-items-center gap-2 mt-4">
                                ...
                                <p class="balance-card_title">300</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-content_header d-flex justify-content-between align-items-center">
                        ...
                        <div class="dashboard-content_search d-flex gap-2">
                            <div class="position-relative dashboard-content_search-box d-none d-md-flex">
                                ...
                                <img src="../assets/img/svg/search-black.svg" class="position-absolute top-50 start-0 translate-middle-y ms-3" alt="">
                            </div>
